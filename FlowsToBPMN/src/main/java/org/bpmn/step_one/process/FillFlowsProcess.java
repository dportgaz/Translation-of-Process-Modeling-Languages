...
public class FillFlowsProcess {
    ...
    public Task findTaskById(Double id, ConcreteObjectType objectMap, String key, FlowsProcess f) throws FileNotFoundException {
    ...
    public AbstractObjectType findObjectById(Double id, ConcreteObjectType objectMap, String key) throws FileNotFoundException {
    ...
    public void fillProcess(Document doc, Element rootElement, Element process, ConcreteObjectType objectMap, FlowsProcess fp, String key, int i) throws FileNotFoundException {
    ...
    public static void addDataObjects(ConcreteObjectType objectMap, String key, int i, FlowsProcess fp, Document doc, Element process) {
    ...
    public void addFlowsToGateways(ConcreteObjectType objectMap, String key, int i, FlowsProcess fp, Document doc, Element process) {
    ...
    public void addFlowsToEvents(ConcreteObjectType objectMap, String key, int i, FlowsProcess fp, Document doc, Element process) {
    ...
    public void addEndEventSequenceFlows(ConcreteObjectType objectMap, String key, FlowsProcess fp, Document doc, Element process) {
    ...
    public void addEndEvent(Document doc, FlowsProcess fp, Element process, ConcreteObjectType objectMap, String key) throws FileNotFoundException {
    ...
    public void addSteps(ConcreteObjectType objectMap, String key, int i, FlowsProcess fp, Document doc, Element process) throws FileNotFoundException {
    ...
    public boolean stepIsPredicate(ConcreteObjectType objectMap, String key, Double id, FlowsProcess fp, Document doc, Element process) throws FileNotFoundException {
    ...
    public void addPredicates(ConcreteObjectType objectMap, String key, int i, FlowsProcess fp, Document doc, Element process) throws FileNotFoundException {
    ...
    public Predicate findPredicate(Double id, ConcreteObjectType objectMap, String key, int i, FlowsProcess fp, Document doc, Element process) throws FileNotFoundException {
    ...
    public String findAttributeOfPredicate(Double id, ConcreteObjectType objectMap, String key) throws FileNotFoundException {
    ...
    public void addLoop(Document doc, FlowsProcess fp, ConcreteObjectType objectMap, String key, Element process) throws
            FileNotFoundException {
    ...
    public void addDecision(Document doc, FlowsProcess fp, ConcreteObjectType objectMap, String key, Element process) throws
            FileNotFoundException {
    ...
    public void openDecisionFlows(ArrayList<SequenceFlow> flows, Document doc, FlowsProcess fp, ConcreteObjectType
    ...
    public void combineArtifcats(Document doc, FlowsProcess fp, ConcreteObjectType objectMap, String key, Element
            process) {
